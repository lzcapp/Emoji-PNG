...
4. **JoyPixels** from [EmojiReplacer/Emoji-Replacer](https://github.com/EmojiReplacer/Emoji-Replacer) (Previous versions from [JoyPixels® Official Site](https://www.joypixels.com/download) and [Arch Linux - ttf-joypixels](https://archlinux.org/packages/extra/any/ttf-joypixels/)).
